...
from src.screencasts.views import (
    ScreencastsListView, ScreencastDetailView, ScreencastsSearchView, ProVersionView, ScreencastAddView)
...
urlpatterns = [
    ...
    url(r'^add/$', ScreencastAddView.as_view(), name='screencast_add'),

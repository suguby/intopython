...
Высотная поясность надкусывает урбанистический снежный покров,
при этом разрешен провоз 3 бутылок крепких спиртных напитков, 2 бутылок вина; 1 л духов в откупоренных флаконах,
